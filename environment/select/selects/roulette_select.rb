...
require_relative '../abstract_select.rb'

class RouletteSelect < GeneticAlgo::Environment::Select::AbstractSelect
  def self.select_logic(points)
    array_sum = points.sum
    chosen_num = array_sum * rand()
    cumu_array = cumulative_sum(points)
